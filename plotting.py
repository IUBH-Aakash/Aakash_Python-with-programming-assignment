...
def plot_ideal_functions(ideal_functions, file_name):
    ...
    # Unpacking will be used to give arguments
    show(column(*plots))


def plot_points_with_their_ideal_function(points_with_classification, file_name):
    """
    It Plot all points that have a matched classification
...
def plot_graph_from_two_functions(scatter_function, line_function, squared_error):
    """
    It plots a scatter for the train_function and a line for the ideal_function
    :param scatter_function: train function
    :param line_function: ideal function
    :param squared_error: Squared error will be plotted in the title
    """
...
def plot_classification(point, ideal_function):
    """
    It plots the classification function and a point on top and display the tolerance.
    ...
    if ideal_function is not None:
        ...
        # It will show tolerance within the graph
